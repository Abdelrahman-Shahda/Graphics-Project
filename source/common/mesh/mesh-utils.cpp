...
#define WHITE   GraphicsProject::Color(255, 255, 255, 255)
#define GRAY    GraphicsProject::Color(128, 128, 128, 255)
#define BLACK   GraphicsProject::Color(  0,   0,   0, 255)
#define RED     GraphicsProject::Color(255,   0,   0, 255)
#define GREEN   GraphicsProject::Color(  0, 255,   0, 255)
#define BLUE    GraphicsProject::Color(  0,   0, 255, 255)
#define MAGENTA GraphicsProject::Color(255,   0, 255, 255)
#define YELLOW  GraphicsProject::Color(255, 255,   0, 255)
#define CYAN    GraphicsProject::Color(  0, 255, 255, 255)

bool GraphicsProject::mesh_utils::loadOBJ(GraphicsProject::Mesh &mesh, const char* filename) {
    ...
    std::vector<GraphicsProject::Vertex> vertices;
    ...
    std::unordered_map<GraphicsProject::Vertex, GLuint> vertex_map;
    ...
    mesh.create({GraphicsProject::setup_buffer_accessors<Vertex>});
...
void GraphicsProject::mesh_utils::Cuboid(Mesh& mesh,
            bool colored_faces,
...
void GraphicsProject::mesh_utils::Sphere(GraphicsProject::Mesh& mesh, const glm::ivec2& segments, bool colored,
    ...
    for(int lat = 0; lat <= segments.y; lat++){
        ...
        for(int lng = 0; lng <= segments.x; lng++){
            ...
            GraphicsProject::Color color = colored ? GraphicsProject::Color(127.5f * (normal + 1.0f), 255) : WHITE;
...
void GraphicsProject::mesh_utils::Plane(GraphicsProject::Mesh& mesh, const glm::ivec2& resolution, bool colored,
    ...
    for(it.x = 0; it.x <= resolution.x; it.x++){
        ...
        for(it.y = 0; it.y <= resolution.y; it.y++){
            ...
            GraphicsProject::Color color = colored ? glm::mix(
                    glm::mix(GraphicsProject::Color(255, 0, 0, 255), GraphicsProject::Color(0, 255, 0, 255), uv.s),
                    glm::mix(GraphicsProject::Color(255, 255, 0, 255), GraphicsProject::Color(0, 0, 255, 255), uv.s),
                    uv.t) : WHITE;
