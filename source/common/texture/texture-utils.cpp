...
glm::ivec2 GraphicsProject::texture_utils::loadImage(GLuint texture, const char *filename, bool generate_mipmap) {
    glm::ivec2 size;
    int channels;
...
glm::ivec2 GraphicsProject::texture_utils::loadImageGrayscale(GLuint texture, const char *filename, bool generate_mipmap) {
    glm::ivec2 size;
    int channels;
    //Since OpenGL puts the texture origin at the bottom left while images typically has the origin at the top left,
    //We need to till stb to flip images vertically after loading them
...
void GraphicsProject::texture_utils::singleColor(GLuint texture, GraphicsProject::Color color, glm::ivec2 size){
...
void GraphicsProject::texture_utils::checkerBoard(GLuint texture, glm::ivec2 size, glm::ivec2 patternSize, GraphicsProject::Color color1, GraphicsProject::Color color2){
    auto* data = new GraphicsProject::Color[size.x * size.y];
    int ptr = 0;
